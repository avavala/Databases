...
DROP DATABASE wsb_video;
--
-- Name: wsb_video; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE wsb_video WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'English_United States.1252';


ALTER DATABASE wsb_video OWNER TO postgres;
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '$$PATH$$/3540.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '$$PATH$$/3548.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '$$PATH$$/3542.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '$$PATH$$/3550.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '$$PATH$$/3552.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '$$PATH$$/3538.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '$$PATH$$/3544.dat';
...
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '$$PATH$$/3545.dat';
...
\.
COPY public.film_category (film_id, category_id, last_update) FROM '$$PATH$$/3546.dat';
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '$$PATH$$/3554.dat';
...
\.
COPY public.language (language_id, name, last_update) FROM '$$PATH$$/3556.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '$$PATH$$/3558.dat';
...
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '$$PATH$$/3560.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '$$PATH$$/3562.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '$$PATH$$/3564.dat';
